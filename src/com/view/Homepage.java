...
public class Homepage extends JFrame {
	...
	private JLabel getLblNewLabel_2() {
		if (lblNewLabel_2 == null) {
			...
			lblNewLabel_2.setBounds(564, 21, 129, 14);
		}
	...
	private JLabel getLblNewLabel_3() {
		if (lblNewLabel_3 == null) {
			...
			lblNewLabel_3.setBounds(760, 21, 63, 14);
		}
	...
	private JLabel getLblNewLabel_6() {
		if (lblNewLabel_6 == null) {
			...
			lblNewLabel_6.setBounds(193, 11, 34, 34);
			lblNewLabel_6.setIcon(new ImageIcon(new ImageIcon("C:\\Users\\hp\\Desktop\\icons\\new.jpg").getImage().getScaledInstance(lblNewLabel_6.getWidth(), lblNewLabel_6.getHeight(), 0)));
	...
	private JLabel getLblNewLabel_7() {
		if (lblNewLabel_7 == null) {
			...
			lblNewLabel_7.setIcon(new ImageIcon(new ImageIcon("C:\\Users\\hp\\Desktop\\icons\\search.png").getImage().getScaledInstance(lblNewLabel_7.getWidth(), lblNewLabel_7.getHeight(), 0)));
	...
	private JLabel getLblNewLabel_8() {
		if (lblNewLabel_8 == null) {
			...
			lblNewLabel_8.setIcon(new ImageIcon(new ImageIcon("C:\\Users\\hp\\Desktop\\icons\\product info.png").getImage().getScaledInstance(lblNewLabel_8.getWidth(), lblNewLabel_8.getHeight(), 0)));
	...
	private JLabel getLblNewLabel_9() {
		if (lblNewLabel_9 == null) {
			...
			lblNewLabel_9.setBounds(718, 11, 32, 34);
